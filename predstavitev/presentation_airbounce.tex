...
\begin{gather}
t = T_c \tau,  \quad d_i = D_c \sigma_i, \quad
\dv{v_i}{t} = \dfrac{D_c}{T_c^2} \, \dv{\nu_i}{\tau} = \dfrac{D_c}{T_c^2} \nu_i'\\
\mqty( \dot{v_1} \\ \dot{v_2}\\)_D = K  C_L v \mqty(-v_2 \\ v_1\\)_D + K C_D v \mqty(-v_1 \\ -v_2\\)_D - g  \mqty(\sin \theta \\ \cos \theta)_D
\end{gather}
$$\Downarrow$$
\begin{gather}
\mqty( \nu_1' \\ \nu_2' \\)_D = K  C_L v \mqty(-v_2 \\ v_1\\)_D + K C_D v \mqty(-v_1 \\ -v_2\\)_D - g  \mqty(\sin \theta \\ \cos \theta)_D
\end{gather}
