...
\begin{figure}[H]
	\centering
	  ...
	  \vspace{-3mm}
	  \captionsetup{justification=centering,margin=0cm}
	  \caption{Distance and depth to the bounce minimum depending on angle of attack.}
\end{figure}
...
\begin{figure}[H]
	\centering
	  \includegraphics[width= 0.9\textwidth]{fazni_diagram_4x.pdf}
	  \vspace{-5mm}
	  \captionsetup{justification=centering,margin=0cm}
	  \caption{Phase diagram, color represents trajectory curvature at the minimum.}
\end{figure}
